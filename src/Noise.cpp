...
inline static int
fastfloor(const float x)
{
	return x > 0 ? (int) x : (int) x - 1;
}

inline static float
dot(const int* g, const float x, const float y)
{
	return g[0]*x + g[1]*y;
}

inline static float
dot(const int* g, const float x, const float y, const float z)
{
	return g[0]*x + g[1]*y + g[2]*z;
}

inline static float
dot(const int* g, const float x, const float y, const float z, const float w)
{
